...
export const references = [
  ...
  {
    title: 'In den Eschen 12, Wülfrath',
    type: 'Verwaltungsreferenz',
    text: 'Görtzheide ergänzt den regionalen Referenzbereich und zeigt die strukturierte Begleitung von Bestandsimmobilien mit Fokus auf Übersicht, Erreichbarkeit und dauerhafte Objektqualität.',
    image: publicAsset('/assets/references/eschen12.png'),
    accent: 'cool',
  },
  {
    title: 'Am Höfchen 7, Wülfrath',
    type: 'Verwaltungsreferenz',
    text: 'Görtzheide ergänzt den regionalen Referenzbereich und zeigt die strukturierte Begleitung von Bestandsimmobilien mit Fokus auf Übersicht, Erreichbarkeit und dauerhafte Objektqualität.',
    image: publicAsset('/assets/references/hoefchen7.png'),
    accent: 'cool',
  },
  {
  ...
  {
    title: 'Südstraße 20, Wülfrath',
    type: 'Verwaltungsreferenz',
    text: 'Görtzheide ergänzt den regionalen Referenzbereich und zeigt die strukturierte Begleitung von Bestandsimmobilien mit Fokus auf Übersicht, Erreichbarkeit und dauerhafte Objektqualität.',
    image: publicAsset('/assets/references/suedstrasse20.png'),
    accent: 'cool',
  },
];
